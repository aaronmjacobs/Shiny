...
Mesh::Mesh(UPtr<float[]> vertices, unsigned int numVertices, UPtr<float[]> normals, unsigned int numNormals,
   ...
   : vbo(0), nbo(0), ibo(0), tbo(0), numVertices(numVertices), numIndices(numIndices), dimensionality(dimensionality) {
...
Mesh::Mesh(Mesh &&other)
   : vbo(other.vbo), nbo(other.nbo), ibo(other.ibo), tbo(other.tbo), vertices(std::move(other.vertices)),
     indices(std::move(other.indices)), numVertices(other.numVertices), numIndices(other.numIndices),
     dimensionality(other.dimensionality) {
   other.vbo = other.nbo = other.ibo = other.tbo = other.numVertices = other.numIndices = other.dimensionality = 0;
}
